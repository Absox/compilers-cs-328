...
string BasicCodeGenerator::getContent() {
    return stream.str();
}

void BasicCodeGenerator::calculateOffsets() throw (CodeGenerationException) {
...
unsigned long long BasicCodeGenerator::calculateScopeOffsets(
...
unsigned long long BasicCodeGenerator::getTypeSize(const shared_ptr<Type> &type) {
...
void BasicCodeGenerator::initializeProgram() {
    indent();
...
void BasicCodeGenerator::finalizeProgram() {
...
void BasicCodeGenerator::processInstructions(
        const vector<shared_ptr<Instruction>> &instructions) {
...
void BasicCodeGenerator::processInstruction(
...
void BasicCodeGenerator::processAssign(const shared_ptr<Assign> &assign) {
...
void BasicCodeGenerator::processIfInstruction(
...
void BasicCodeGenerator::processRepeat(const shared_ptr<Repeat> &repeat) {
...
void BasicCodeGenerator::processRead(const shared_ptr<Read> &read) {
...
void BasicCodeGenerator::processWrite(const shared_ptr<Write> &write) {
...
void BasicCodeGenerator::resolveCondition(
...
void BasicCodeGenerator::resolveLocationOffset(
...
shared_ptr<Type> BasicCodeGenerator::getLocationType(
        const shared_ptr<Location> &location) {
    auto variable = dynamic_pointer_cast<VariableLocation>(location);
    auto index = dynamic_pointer_cast<Index>(location);
    auto field = dynamic_pointer_cast<Field>(location);
...
void BasicCodeGenerator::resolveExpressionValue(
...
void BasicCodeGenerator::indent() {
    indentLevel++;
}

void BasicCodeGenerator::deindent() {
    indentLevel--;
}

void BasicCodeGenerator::writeWithIndent(const string &value) {
...
int BasicCodeGenerator::getNextLabelIndex() {
    return labelCounter++;
}
